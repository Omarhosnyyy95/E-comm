...
class NakSpider(scrapy.Spider):
    name = 'nak'
    allowed_domains = ['www.nak.gr']
    # start_urls = ['http://www.nak.gr/']
        # access the website
    def start_requests(self):
        
        # working with xpath for this website

        main_page_url = 'https://www.nak.gr/'
        categories = {
            'Women': 'https://www.nak.gr/gr/el-gynaikeia-papoytsia.html', 
            'Men': 'https://www.nak.gr/gr/el-andrika-papoytsia.html', 
            'Children': 'https://www.nak.gr/gr/el-paidika-papoytsia.html', 
            'Bags Accessories': 'https://www.nak.gr/gr/tsantes-axesouar.html', 
            }
        
        products_sel = "//div[@class='products wrapper']/div"
        product_link_sel = ".//div[@class='product-item-info']/a/@href"
        product_image_sel = ".//div[@class='product-item-info']/a//img/@src"
        product_title_sel = ".//div[@class='product details product-item-details']/strong[@class='product name product-item-name']/a/text()"
        product_brand_sel = ".//div[@class='product details product-item-details']/strong[@class='product brand']/text()"
        product_code_sel = ".//div[@class='product details product-item-details']/strong[@class='product name product-item-name']/a/text()"
        old_price_sel = ".//div[@class='price-box price-final_price']//span[@class='old-price no-display']//span[@class='price']/text()"
        new_price_sel = ".//div[@class='price-box price-final_price']//span[@data-price-type='finalPrice']//span[@class='price']/text()"
        price_sel = ".//div[@class='price-box price-final_price']//span[@data-price-type='finalPrice']//span[@class='price']/text()"
