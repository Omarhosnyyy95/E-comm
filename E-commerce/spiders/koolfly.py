...
class WomenSpider(scrapy.Spider):
    name = 'koolfly'
    allowed_domains = ['www.koolfly.com']
    ...
    def start_requests(self):
        ...
        # main_page_url, categories_links, post_selector, next_page_selector, post_title_selector, product_meta = self.get_data(host="localhost", user="root", db="plugin_test", passwd="", website_id=8)
        main_page_url = 'https://www.koolfly.com/'
        categories = {
            'Woman': 'https://www.koolfly.com/en/woman', 
            'Man': "https://www.koolfly.com/en/man",
            'Kid': "https://www.koolfly.com/en/kid", 
            }
        
        products_sel = "//div[@class='category-products']/ul/li"
        product_link_sel = ".//a[@class='product-image']/@href"
        product_image_sel = ".//a[@class='product-image']/span[1]/img/@src"
        product_title_sel = ".//h3/a[2]/text()"
        product_brand_sel = ".//h4/text()"
        product_code_sel = ".//@data-id"
        old_price_sel = ".//p[@class='old-price']/span[2]/text()"
        new_price_sel = ".//p[@class='special-price']/span[2]/text()"
        price_sel = ".//p[@class='regular-price']/span[2]/text()"
        next_page_sel = "//a[@class='next i-next']/@href"
        # post_link_selector = ''
    ...
    #     products = response.css(post_selector+"::attr(href)").getall()
    ...
    #             meta={
    #                 "main_page_url": main_page_url,
    #                 "title_selector": post_title_selector,
    #                 "product_meta": product_meta
    #             }
    #         )
    ...
    #     scraping_time = datetime.now()
    #     main_page_url = response.meta['main_page_url']
    #     title_selector = response.meta['title_selector']
    #     product_meta = response.meta['product_meta']
    #     post_link = response.url
        

    #     # issue the selectors has the product id which is not known!!!!
