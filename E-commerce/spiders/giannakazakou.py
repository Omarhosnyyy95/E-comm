...
class GiannakazakouSpider(scrapy.Spider):
    name = 'giannakazakou'
    allowed_domains = ['www.giannakazakou.gr']
    # start_urls = ['http://www.giannakazakou.gr/']
    ...
    def start_requests(self):
        ...
        # main_page_url, categories_links, post_selector, next_page_selector, post_title_selector, product_meta = self.get_data(host="localhost", user="root", db="plugin_test", passwd="", website_id=249)
        main_page_url = 'https://www.giannakazakou.gr/'
        categories = {
            'Women': 'https://www.giannakazakou.gr/gynaikeia-papoutsia', 
            'Men': 'https://www.giannakazakou.gr/andrika-papoutsia', 
            'Children': 'https://www.giannakazakou.gr/paidika-papoutsia', 
            'Underwear': 'https://www.giannakazakou.gr/esorouxa', 
            'Accessory': 'https://www.giannakazakou.gr/aksesouar', 
            'Bags': 'https://www.giannakazakou.gr/tsantes'
            }
        ...
        products_sel = "//ul[@class='products-grid']/li"
        product_link_sel = ".//div[@class='product-visual-container']/div[2]/a[1]/@href"
        product_image_sel = ".//div[@class='product-visual-container']/div[2]/a[1]/img/@long-desc"
        product_title_sel = ".//div[@class='product-visual-container']/div[2]/a[1]/@title"
        product_brand_sel = ".//a[@class='product-brand']/@title"
        product_code_sel = ".//div[@class='product-visual-container']/div[1]/span/@data-product-id" # website product id
        old_price_sel = ".//div[@class='price-box']/span[@class='initial-price']/span/text()"
        new_price_sel = ".//div[@class='price-box']/span[@class='special-price ']/span/text()"
        price_sel = ".//div[@class='price-box']/span[@class='regular-price']/span/text()"
        next_page_sel = "(//td[@class='pages']/ol/li/a[@class='next i-next'])[1]/@href"
        # next page link example: https://www.giannakazakou.gr/gynaikeia-papoutsia/filtro/p/4 (absolute)
    ...
    #     brand = response.css(brand_sel).attrib['alt']
